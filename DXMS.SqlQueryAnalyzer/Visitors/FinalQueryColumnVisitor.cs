...
internal sealed class FinalQueryColumnVisitor : TSqlConcreteFragmentVisitor
{
    ...
    private void ProcessSelectElements(IList<SelectElement> selectElements)
    {
        foreach (var element in selectElements)
        {
            switch (element)
            {
                case SelectScalarExpression scalarExpr:
                    {
                        var column = ProcessSelectScalarExpression(scalarExpr);
                        Columns.Add(column);
                        break;
                    }
                case SelectStarExpression starExpr:
                    {
    ...
    private static ColumnReference ProcessSelectScalarExpression(SelectScalarExpression node)
    {
    ...
    private static ColumnReference ExtractColumnReference(ColumnReferenceExpression colRef, string? alias, ColumnUsageType usageType)
    {
